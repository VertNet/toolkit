...
move "reports\Report - indeterminate Geography.txt"              "reports\Report - Audio - indeterminate Geography.txt"
move "reports\Report - coordinatePrecision not numeric.txt"      "reports\Report - Audio - coordinatePrecision not numeric.txt"
move "reports\Report - coordinatePrecision out of Range.txt"     "reports\Report - Audio - coordinatePrecision out of Range.txt"
move "reports\Report - coordinateUncertainties not numeric.txt"  "reports\Report - Audio - coordinateUncertainties not numeric.txt"
move "reports\Report - coordinateUncertainties out of range.txt" "reports\Report - Audio - coordinateUncertainties out of range.txt"
move "reports\Report - Day out of range.txt"                     "reports\Report - Audio - Day out of range.txt"
move "reports\Report - decimalLatLong both 0.txt"                "reports\Report - Audio - decimalLatLong both 0.txt"
move "reports\Report - decimalLatLong not numeric.txt"           "reports\Report - Audio - decimalLatLong not numeric.txt"
move "reports\Report - decimalLatLong out of range.txt"          "reports\Report - Audio - decimalLatLong out of range.txt"
move "reports\Report - duplicate occurrenceIDs.txt"              "reports\Report - Audio - duplicate occurrenceIDs.txt"
move "reports\Report - duplicate catalogNumber.txt"              "reports\Report - Audio - duplicate catalogNumber.txt"
move "reports\Report - missing catalogNumber.csv"                "reports\Report - Audio - missing catalogNumber.csv"
move "reports\Report - missing coordinate.txt"                   "reports\Report - Audio - missing coordinate.txt"
move "reports\Report - Month out of range.txt"                   "reports\Report - Audio - Month out of range.txt"
move "reports\Report - non-standard Continent.txt"               "reports\Report - Audio - non-standard Continent.txt"
move "reports\Report - non-standard Country.txt"                 "reports\Report - Audio - non-standard Country.txt"
move "reports\Report - non-standard County.txt"                  "reports\Report - Audio - non-standard County.txt"
move "reports\Report - non-standard Family.txt"                  "reports\Report - Audio - non-standard Family.txt"
move "reports\Report - non-standard Genus.txt"                   "reports\Report - Audio - non-standard Genus.txt"
move "reports\Report - non-standard Island.txt"                  "reports\Report - Audio - non-standard Island.txt"
move "reports\Report - non-standard IslandGroup.txt"             "reports\Report - Audio - non-standard IslandGroup.txt"
move "reports\Report - non-standard Municipality.txt"            "reports\Report - Audio - non-standard Municipality.txt"
move "reports\Report - non-standard Order.txt"                   "reports\Report - Audio - non-standard Order.txt"
move "reports\Report - non-standard StateProvince.txt"           "reports\Report - Audio - non-standard StateProvince.txt"
move "reports\Report - non-standard WaterBody.txt"               "reports\Report - Audio - non-standard WaterBody.txt"
move "reports\Report - not higherGeography.txt"                  "reports\Report - Audio - not higherGeography.txt"
move "reports\Report - Year out of range.txt"                    "reports\Report - Audio - Year out of range.txt"
