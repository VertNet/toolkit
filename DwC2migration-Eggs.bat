...
move "reports\Report - indeterminate Geography.txt"              "reports\Report - Eggs-Nests - indeterminate Geography.txt"
move "reports\Report - coordinatePrecision not numeric.txt"      "reports\Report - Eggs-Nests - coordinatePrecision not numeric.txt"
move "reports\Report - coordinatePrecision out of Range.txt"     "reports\Report - Eggs-Nests - coordinatePrecision out of Range.txt"
move "reports\Report - coordinateUncertainties not numeric.txt"  "reports\Report - Eggs-Nests - coordinateUncertainties not numeric.txt"
move "reports\Report - coordinateUncertainties out of range.txt" "reports\Report - Eggs-Nests - coordinateUncertainties out of range.txt"
move "reports\Report - Day out of range.txt"                     "reports\Report - Eggs-Nests - Day out of range.txt"
move "reports\Report - decimalLatLong both 0.txt"                "reports\Report - Eggs-Nests - decimalLatLong both 0.txt"
move "reports\Report - decimalLatLong not numeric.txt"           "reports\Report - Eggs-Nests - decimalLatLong not numeric.txt"
...
move "reports\Report - non-standard Continent.txt"               "reports\Report - Eggs-Nests - non-standard Continent.txt"
move "reports\Report - non-standard Country.txt"                 "reports\Report - Eggs-Nests - non-standard Country.txt"
move "reports\Report - non-standard County.txt"                  "reports\Report - Eggs-Nests - non-standard County.txt"
move "reports\Report - non-standard Family.txt"                  "reports\Report - Eggs-Nests - non-standard Family.txt"
move "reports\Report - non-standard Genus.txt"                   "reports\Report - Eggs-Nests - non-standard Genus.txt"
move "reports\Report - non-standard Island.txt"                  "reports\Report - Eggs-Nests - non-standard Island.txt"
move "reports\Report - non-standard IslandGroup.txt"             "reports\Report - Eggs-Nests - non-standard IslandGroup.txt"
move "reports\Report - non-standard Municipality.txt"            "reports\Report - Eggs-Nests - non-standard Municipality.txt"
move "reports\Report - non-standard Order.txt"                   "reports\Report - Eggs-Nests - non-standard Order.txt"
move "reports\Report - non-standard StateProvince.txt"           "reports\Report - Eggs-Nests - non-standard StateProvince.txt"
move "reports\Report - non-standard WaterBody.txt"               "reports\Report - Eggs-Nests - non-standard WaterBody.txt"
move "reports\Report - not higherGeography.txt"                  "reports\Report - Eggs-Nests - not higherGeography.txt"
move "reports\Report - Year out of range.txt"                    "reports\Report - Eggs-Nests - Year out of range.txt"
