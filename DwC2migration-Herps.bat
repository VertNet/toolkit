...
move "reports\Report - indeterminate Geography.txt"              "reports\Report - Herps - indeterminate Geography.txt"
move "reports\Report - coordinatePrecision not numeric.txt"      "reports\Report - Herps - coordinatePrecision not numeric.txt"
move "reports\Report - coordinatePrecision out of Range.txt"     "reports\Report - Herps - coordinatePrecision out of Range.txt"
move "reports\Report - coordinateUncertainties not numeric.txt"  "reports\Report - Herps - coordinateUncertainties not numeric.txt"
move "reports\Report - coordinateUncertainties out of range.txt" "reports\Report - Herps - coordinateUncertainties out of range.txt"
move "reports\Report - Day out of range.txt"                     "reports\Report - Herps - Day out of range.txt"
move "reports\Report - decimalLatLong both 0.txt"                "reports\Report - Herps - decimalLatLong both 0.txt"
move "reports\Report - decimalLatLong not numeric.txt"           "reports\Report - Herps - decimalLatLong not numeric.txt"
move "reports\Report - decimalLatLong out of range.txt"          "reports\Report - Herps - decimalLatLong out of range.txt"
move "reports\Report - duplicate occurrenceIDs.txt"              "reports\Report - Herps - duplicate occurrenceIDs.txt"
move "reports\Report - duplicate catalogNumber.txt"              "reports\Report - Herps - duplicate catalogNumber.txt"
move "reports\Report - individualCount out of range.txt"         "reports\Report - Herps - individualCount out of range.txt"
move "reports\Report - missing catalogNumber.csv"                "reports\Report - Herps - missing catalogNumber.csv"
move "reports\Report - missing coordinate.txt"                   "reports\Report - Herps - missing coordinate.txt"
move "reports\Report - Month out of range.txt"                   "reports\Report - Herps - Month out of range.txt"
move "reports\Report - non-standard Continent.txt"               "reports\Report - Herps - non-standard Continent.txt"
move "reports\Report - non-standard Country.txt"                 "reports\Report - Herps - non-standard Country.txt"
move "reports\Report - non-standard County.txt"                  "reports\Report - Herps - non-standard County.txt"
move "reports\Report - non-standard Family.txt"                  "reports\Report - Herps - non-standard Family.txt"
move "reports\Report - non-standard Genus.txt"                   "reports\Report - Herps - non-standard Genus.txt"
move "reports\Report - non-standard Island.txt"                  "reports\Report - Herps - non-standard Island.txt"
move "reports\Report - non-standard IslandGroup.txt"             "reports\Report - Herps - non-standard IslandGroup.txt"
move "reports\Report - non-standard Municipality.txt"            "reports\Report - Herps - non-standard Municipality.txt"
move "reports\Report - non-standard Order.txt"                   "reports\Report - Herps - non-standard Order.txt"
move "reports\Report - non-standard StateProvince.txt"           "reports\Report - Herps - non-standard StateProvince.txt"
move "reports\Report - non-standard WaterBody.txt"               "reports\Report - Herps - non-standard WaterBody.txt"
move "reports\Report - not higherGeography.txt"                  "reports\Report - Herps - not higherGeography.txt"
move "reports\Report - Year out of range.txt"                    "reports\Report - Herps - Year out of range.txt"
