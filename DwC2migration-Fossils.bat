...
move "reports\Report - indeterminate Geography.txt"              "reports\Report - Fossils - indeterminate Geography.txt"
move "reports\Report - coordinatePrecision not numeric.txt"      "reports\Report - Fossils - coordinatePrecision not numeric.txt"
move "reports\Report - coordinatePrecision out of Range.txt"     "reports\Report - Fossils - coordinatePrecision out of Range.txt"
move "reports\Report - coordinateUncertainties not numeric.txt"  "reports\Report - Fossils - coordinateUncertainties not numeric.txt"
move "reports\Report - coordinateUncertainties out of range.txt" "reports\Report - Fossils - coordinateUncertainties out of range.txt"
move "reports\Report - Day out of range.txt"                     "reports\Report - Fossils - Day out of range.txt"
move "reports\Report - decimalLatLong both 0.txt"                "reports\Report - Fossils - decimalLatLong both 0.txt"
move "reports\Report - decimalLatLong not numeric.txt"           "reports\Report - Fossils - decimalLatLong not numeric.txt"
...
move "reports\Report - individualCount out of range.txt"         "reports\Report - Fossils - individualCount out of range.txt"
...
move "reports\Report - non-standard Continent.txt"               "reports\Report - Fossils - non-standard Continent.txt"
move "reports\Report - non-standard Country.txt"                 "reports\Report - Fossils - non-standard Country.txt"
move "reports\Report - non-standard County.txt"                  "reports\Report - Fossils - non-standard County.txt"
move "reports\Report - non-standard Family.txt"                  "reports\Report - Fossils - non-standard Family.txt"
move "reports\Report - non-standard Genus.txt"                   "reports\Report - Fossils - non-standard Genus.txt"
move "reports\Report - non-standard Island.txt"                  "reports\Report - Fossils - non-standard Island.txt"
move "reports\Report - non-standard IslandGroup.txt"             "reports\Report - Fossils - non-standard IslandGroup.txt"
move "reports\Report - non-standard Municipality.txt"            "reports\Report - Fossils - non-standard Municipality.txt"
move "reports\Report - non-standard Order.txt"                   "reports\Report - Fossils - non-standard Order.txt"
move "reports\Report - non-standard StateProvince.txt"           "reports\Report - Fossils - non-standard StateProvince.txt"
move "reports\Report - non-standard WaterBody.txt"               "reports\Report - Fossils - non-standard WaterBody.txt"
move "reports\Report - not higherGeography.txt"                  "reports\Report - Fossils - not higherGeography.txt"
move "reports\Report - Year out of range.txt"                    "reports\Report - Fossils - Year out of range.txt"
