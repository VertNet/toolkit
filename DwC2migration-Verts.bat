...
move "reports\Report - indeterminate Geography.txt"              "reports\Report - Verts - indeterminate Geography.txt"
move "reports\Report - coordinatePrecision not numeric.txt"      "reports\Report - Verts - coordinatePrecision not numeric.txt"
move "reports\Report - coordinatePrecision out of Range.txt"     "reports\Report - Verts - coordinatePrecision out of Range.txt"
move "reports\Report - coordinateUncertainties not numeric.txt"  "reports\Report - Verts - coordinateUncertainties not numeric.txt"
move "reports\Report - coordinateUncertainties out of range.txt" "reports\Report - Verts - coordinateUncertainties out of range.txt"
move "reports\Report - Day out of range.txt"                     "reports\Report - Verts - Day out of range.txt"
move "reports\Report - decimalLatLong both 0.txt"                "reports\Report - Verts - decimalLatLong both 0.txt"
move "reports\Report - decimalLatLong not numeric.txt"           "reports\Report - Verts - decimalLatLong not numeric.txt"
move "reports\Report - decimalLatLong out of range.txt"          "reports\Report - Verts - decimalLatLong out of range.txt"
move "reports\Report - duplicate occurrenceIDs.txt"              "reports\Report - Verts - duplicate occurrenceIDs.txt"
move "reports\Report - duplicate catalogNumber.txt"              "reports\Report - Verts - duplicate catalogNumber.txt"
move "reports\Report - individualCount out of range.txt"         "reports\Report - Verts - individualCount out of range.txt"
move "reports\Report - missing catalogNumber.csv"                "reports\Report - Verts - missing catalogNumber.csv"
move "reports\Report - missing coordinate.txt"                   "reports\Report - Verts - missing coordinate.txt"
move "reports\Report - Month out of range.txt"                   "reports\Report - Verts - Month out of range.txt"
move "reports\Report - non-standard Continent.txt"               "reports\Report - Verts - non-standard Continent.txt"
move "reports\Report - non-standard Country.txt"                 "reports\Report - Verts - non-standard Country.txt"
move "reports\Report - non-standard County.txt"                  "reports\Report - Verts - non-standard County.txt"
move "reports\Report - non-standard Family.txt"                  "reports\Report - Verts - non-standard Family.txt"
move "reports\Report - non-standard Genus.txt"                   "reports\Report - Verts - non-standard Genus.txt"
move "reports\Report - non-standard Island.txt"                  "reports\Report - Verts - non-standard Island.txt"
move "reports\Report - non-standard IslandGroup.txt"             "reports\Report - Verts - non-standard IslandGroup.txt"
move "reports\Report - non-standard Municipality.txt"            "reports\Report - Verts - non-standard Municipality.txt"
move "reports\Report - non-standard Order.txt"                   "reports\Report - Verts - non-standard Order.txt"
move "reports\Report - non-standard StateProvince.txt"           "reports\Report - Verts - non-standard StateProvince.txt"
move "reports\Report - non-standard WaterBody.txt"               "reports\Report - Verts - non-standard WaterBody.txt"
move "reports\Report - not higherGeography.txt"                  "reports\Report - Verts - not higherGeography.txt"
move "reports\Report - Year out of range.txt"                    "reports\Report - Verts - Year out of range.txt"
